...
public class FakeMainActivityTest {

    @Rule
    public ActivityTestRule<FakeMainActivity> mActivityTestRule = new ActivityTestRule<>(FakeMainActivity.class);

    @Test
    public void fakeMainActivityTest() {
